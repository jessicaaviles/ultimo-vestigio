...
const MapOverview: React.FC = () => {
  ...
  const locations = [
    ...
    { id: 'living_room', title: 'Sala de Estar', status: 'investigating', top: '38%', left: '53%', lineDirection: 'right', totalPistas: 3, clueIds: ['fireplace', 'blood', 'wine_glass'], image: '/backgrounds/scene_living_room_landscape.png?v=11', desc: 'Principal ponto de encontro da família. Foi aqui que Clara Mendes foi vista pela última vez.' },
